...
DATA_DIR = '/home/mmvc/Git/point-to-tell/AdeHand'

class MyTrainingDataset(GetterDataset):
    ...
    def __init__(self, split='train'):
        ...
        self.loader.filter_by_obj_class([13, 16, 20]) # keep only: person, table, chair
        assert self.loader.get_size() > 0
    ...
    def _get_label(self, i):
        ...
        label[label == 255] = -1
        label = self.loader.ade_label_to_voc_label(label)
        # (1, H, W) -> (H, W)
        return label
