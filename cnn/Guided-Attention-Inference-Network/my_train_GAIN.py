...
from my_updater_v2 import VOC_GAIN_Updater_v2
...
def main():
	...
	parser.add_argument('--lr', type=float, default=5e-7, help='init learning rate')
	parser.add_argument('--name', type=str, default='MYGAIN_5_to_1_padding_1_all_update', help='name of the experiment')
	...
	log_keys = ['epoch', 'iteration', 'main/AM_Loss', 'main/CL_Loss', 'main/SG_Loss', 'main/TotalLoss']
	...
	trainer.extend(extensions.PlotReport(['main/AM_Loss'], 'iteration',(50, 'iteration'), file_name=experiment+'/am_loss.png', grid=True, marker=" "))
	trainer.extend(extensions.PlotReport(['main/CL_Loss'], 'iteration',(50, 'iteration'), file_name=experiment+'/cl_loss.png', grid=True, marker=" "))
	trainer.extend(
		extensions.PlotReport(['main/SG_Loss'], 'iteration', (50, 'iteration'), file_name=experiment + '/sg_loss.png',grid=True, marker=" "))
	trainer.extend(extensions.PlotReport(['main/TotalLoss'], 'iteration',(50, 'iteration'), file_name=experiment+'/total_loss.png', grid=True, marker=" "))
	trainer.extend(extensions.PlotReport(log_keys[2:], 'iteration',(50, 'iteration'), file_name=experiment+'/all_loss.png', grid=True, marker=" "))
